...
import 'package:bootloader_host/ProgressBar.dart';
  ...
  Widget build(BuildContext context) {
    return ScaffoldMessenger(
        child: Scaffold(
                  ...
                  builder: (c, snapshot) {
                      ...
                      case BluetoothConnectionState.connected:
                        onPressed = () async {
                          ...
                          try {
                            ...
                            final snackBar =
                                snackBarGood("Disconnect: Success");
                    ...
                    return ValueListenableBuilder<bool>(
                        ...
                        builder: (context, value, child) {
                          isConnectingOrDisconnecting[device.remoteId] ??=
                              ValueNotifier(false);
                          if (isConnectingOrDisconnecting[device.remoteId]!
                                  .value ==
                              true) {
            ...
            body: Scaffold(
              body: Center(child: Consumer<ProgressProvider>(
                  builder: (context, progressProvider, child) {
                return Visibility(
                    visible: progressProvider.showProgress,
                    child:
                        ProgressBar(count: progressProvider.currentProgress));
              })),
              floatingActionButton: Consumer<ProgressProvider>(
                  builder: (context, progressProvider, child) {
                      ...
                      if (result != null) {
                        ...
                        if (pathToFile != "") {
                          ...
                          if (extension == ".cyacd" || extension == ".cyacd2") {
                            int t = await CyBtldr_Program(
                                file, "", 3, device, progressProvider);
